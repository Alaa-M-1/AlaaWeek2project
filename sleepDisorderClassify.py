...
# Load the data
sleep_df = pd.read_csv(r'C:\Users\aaii1\Desktop\Week2project\Sleep_health_and_lifestyle_dataset.csv')
student_df = pd.read_csv(r'C:\Users\aaii1\Desktop\Week2project\Student_performance_data _.csv')
